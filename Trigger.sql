...
INSERT INTO TB_PROFESSOR(COD_PROF, COD_DEPTO, COD_TIT, NOME_PROF) VALUES (1, 'DEP01', 2, 'Leandro');
INSERT INTO TB_PROFESSOR(COD_PROF, COD_DEPTO, COD_TIT, NOME_PROF) VALUES (2, 'DEP02', 2, 'Wellington');

UPDATE TB_PROFESSOR SET NOME_PROF = 'Arnaldo Cruz' WHERE COD_PROF = 4;
UPDATE TB_PROFESSOR SET COD_TIT = 1 WHERE COD_PROF = 3;
    
DELETE FROM TB_PROFESSOR WHERE COD_PROF = 3;
DELETE FROM TB_PROFESSOR WHERE COD_PROF = 4;
