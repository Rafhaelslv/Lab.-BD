...
INNER JOIN TB_ALUNO a on ad.cod_aluno = a.cod_aluno
INNER JOIN TB_DISCIPLINA d on ad.id_disciplina = d.id_disciplina
WHERE 
	d.nome_disciplina IN ('MATEMATICA', 'PORTUGUES')
GROUP BY a.nome_aluno
HAVING COUNT(DISTINCT d.nome_disciplina) = 2
